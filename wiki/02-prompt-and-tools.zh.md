> **语言 / Language**: [English](02-prompt-and-tools.md) · **中文**
...
- [完整请求逐段注解](02-appendix/02-full-request-annotated.zh.md) — 第 3 轮请求的 instructions + tools + 10 条 messages + LLM 回复，逐字段展示
...
**上一章**: [01 — 架构总览](01-architecture-overview.zh.md) | **下一章**: [03 — Agent Loop 深度剖析](03-agent-loop.zh.md)
