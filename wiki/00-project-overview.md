...
Codex 的 Rust 部分是一个包含 **88 个 crate** 的 Cargo workspace（见 [Cargo.toml:1-91](https://github.com/openai/codex/blob/main/codex-rs/Cargo.toml#L1-L91)）。这些 crate 按功能可以分为以下几大类：
