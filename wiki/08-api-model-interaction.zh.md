> **语言 / Language**: [English](08-api-model-interaction.md) · **中文**
...
Agent Loop 消费这些事件来驱动工具执行和 UI 更新（详见 [03 — Agent Loop](03-agent-loop.zh.md)）。
...
**上一章**: [07 — 审批与安全系统](07-approval-safety.zh.md) | **下一章**: [09 — MCP、Skills 与插件](09-mcp-skills-plugins.zh.md)
