> **语言 / Language**: [English](01-architecture-overview.md) · **中文**
...
**详见**: [03 — Agent Loop 深度剖析](03-agent-loop.zh.md)
...
**详见**: [04 — 工具系统设计](04-tool-system.zh.md)
...
**详见**: [05 — 上下文与对话管理](05-context-management.zh.md)
...
**详见**: [06 — 子 Agent 与任务委派](06-sub-agent-system.zh.md)
...
**详见**: [07 — 审批与安全系统](07-approval-safety.zh.md)
...
**详见**: [08 — API 与模型交互](08-api-model-interaction.zh.md)
...
**详见**: [09 — MCP、Skills 与插件](09-mcp-skills-plugins.zh.md)
...
**详见**: [10 — 产品集成与 App Server](10-sdk-protocol.zh.md)
...
**详见**: [11 — 配置系统](11-config-system.zh.md)
...
| 子系统 | 核心问题 | 章节 |
|--------|---------|------|
| Agent Loop | 模型如何驱动多轮工具调用？ | [03](03-agent-loop.zh.md) |
| 工具系统 | 工具调用如何路由、审批和执行？ | [04](04-tool-system.zh.md) |
| 上下文管理 | 对话超长时如何压缩？ | [05](05-context-management.zh.md) |
| 子 Agent | 如何派生并行 Agent？ | [06](06-sub-agent-system.zh.md) |
| 安全模型 | 三层防线如何保护用户环境？ | [07](07-approval-safety.zh.md) |
| 模型交互 | 如何与多种 LLM 供应商通信？ | [08](08-api-model-interaction.zh.md) |
| 扩展体系 | Skills/MCP/Plugin 如何扩展能力？ | [09](09-mcp-skills-plugins.zh.md) |
| 产品集成 | 多产品如何共享同一 Agent 内核？ | [10](10-sdk-protocol.zh.md) |
| 配置系统 | 值层与约束层如何合并？ | [11](11-config-system.zh.md) |

---

**上一章**: [00 — 项目概览](00-project-overview.zh.md) | **下一章**: [02 — 提示词与工具解析](02-prompt-and-tools.zh.md)
